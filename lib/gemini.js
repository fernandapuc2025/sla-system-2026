...
// Inicializa a biblioteca com a chave de ambiente
const genAI = new GoogleGenerativeAI(process.env.GOOGLE_API_KEY);

export async function analisarDocumento(texto) {
  try {
    // Usamos 'gemini-1.5-flash' - o SDK mais novo cuidará do resto
    // Se o erro 404 persistir, o problema é a versão do pacote no package.json
